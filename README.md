...
| `src/tts/` | Pocket TTS flow-matching LM + a [Mimi](https://github.com/kyutai-labs/moshi)-inspired streaming neural-codec decoder (with the fused per-frame decode) and a streaming `AudioContext` player. |
