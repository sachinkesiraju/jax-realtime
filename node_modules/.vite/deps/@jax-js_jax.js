import { A as getBackend, C as defaultDevice, E as dtypedJsArray, F as isNumberPair, G as recursiveFlatten, H as prod$1, I as isPermutation, J as setDebug, K as rep, M as init, N as invertPermutation, P as isFloatDtype, Q as toposort, S as deepEqual, T as dtypedArray, U as promoteTypes, V as partitionList, W as range, X as stopTrace, Y as startTrace, _ as accessorGlobal, a as DType, at as zipn, b as checkInts, c as Kernel, d as Routine, f as ShapeTracker, g as accessorAluExp, i as DEBUG, it as zip, j as getWebGPUDevice, k as generalBroadcast, l as PPrint, n as AluGroup, nt as unravelAlu, q as runWithCache, r as AluVar, rt as unzip2, s as FpHash, t as AluExp, u as Reduction, v as byteWidth, w as devices, x as checkSquare, y as checkAxis, z as normalizeAxis } from "./backend-Be4lJ1CU-AZOnUAoD.js";
//#region node_modules/@jax-js/jax/dist/rolldown-runtime-D7D4PA-g.js
...
//#endregion
//#region node_modules/@jax-js/jax/dist/index.js
/**
...
*/
var cross = jit$1(function cross(a, b, { axisa = -1, axisb = -1, axisc = -1, axis } = {}) {
	if (axis !== void 0) {
		axisa = axis;
		axisb = axis;
		axisc = axis;
...
*/
var copysign = jit$1(function copysign(x, y) {
...
*/
var heaviside = jit$1(function heaviside(x1, x2) {
...
*/
var sinc = jit$1(function sinc(x) {
...
*/
var hypot = jit$1(function hypot(x1, x2) {
...
*/
var atan2 = jit$1(function atan2(y, x) {
...
*/
var fmod = jit$1(function fmod(x, y) {
...
*/
var remainder = jit$1(function remainder(x, y) {
...
*/
var round = jit$1(function round(a, decimals = 0) {
...
*/
var rint = jit$1(function rint(x) {
...
*/
var logaddexp = jit$1(function logaddexp(x1, x2) {
...
*/
var logaddexp2 = jit$1(function logaddexp2(x1, x2) {
	const xmax = maximum(x1.ref, x2.ref);
...
*/
var power = jit$1(function power(x1, x2) {
...
var cbrt = jit$1(function cbrt(x) {
...
*/
var sinh = jit$1(function sinh(x) {
	const ex = exp(x);
...
*/
var cosh = jit$1(function cosh(x) {
	const ex = exp(x);
	const emx = reciprocal(ex.ref);
...
*/
var tanh = jit$1(function tanh(x) {
...
*/
var arcsinh = jit$1(function arcsinh(x) {
...
*/
var arccosh = jit$1(function arccosh(x) {
...
*/
var arctanh = jit$1(function arctanh(x) {
...
*/
var isfinite = jit$1(function isfinite(x) {
...
*/
var silu = jit$1(function silu(x) {
...
*/
var selu = jit$1(function selu(x) {
...
*/
var gelu = jit$1(function gelu(x, opts) {
...
*/
var uniform = jit$1(function uniform(key, shape = [], { minval = 0, maxval = 1 } = {}) {
...
*/
var ball = jit$1(function ball(key, d, { p = 2, shape = [] } = {}) {
...
*/
var categorical = jit$1(function categorical(key, logits, { axis = -1, shape, replace = true } = {}) {
...
*/
var cauchy = jit$1(function cauchy(key, shape = []) {
...
*/
var doubleSidedMaxwell = jit$1(function doubleSidedMaxwell(key, loc, scale, shape = []) {
	loc = fudgeArray(loc);
...
*/
var exponential = jit$1(function exponential(key, shape = []) {
...
*/
var geometric = jit$1(function geometric(key, p, { shape = [], dtype = "int32" } = {}) {
	p = fudgeArray(p);
...
*/
var gumbel = jit$1(function gumbel(key, shape = []) {
...
*/
var laplace = jit$1(function laplace(key, shape = []) {
...
*/
var logistic = jit$1(function logistic(key, shape = []) {
...
*/
var lognormal = jit$1(function lognormal(key, sigma = 1, shape = []) {
...
*/
var maxwell = jit$1(function maxwell(key, shape = []) {
...
*/
var multivariateNormal = jit$1(function multivariateNormal(key, mean, cov, shape = []) {
...
*/
var normal = jit$1(function normal(key, shape = []) {
	const [k1, k2] = split(key, 2);
...
*/
var pareto = jit$1(function pareto(key, b, shape = []) {
	b = fudgeArray(b);
...
*/
var rademacher = jit$1(function rademacher(key, { shape = [], dtype = "int32" } = {}) {
...
*/
var randint = jit$1(function randint(key, { minval, maxval, shape = [], dtype = "int32" }) {
...
*/
var rayleigh = jit$1(function rayleigh(key, scale = 1, shape = []) {
	scale = fudgeArray(scale);
...
*/
var triangular = jit$1(function triangular(key, left, mode, right, shape = []) {
...
*/
var weibullMin = jit$1(function weibullMin(key, scale, concentration, shape = []) {
	scale = fudgeArray(scale);
...
*/
var logit = jit$1(function logit(x) {
...
* ```
*/
var valueAndGrad = valueAndGrad$1;
/**
* @function
