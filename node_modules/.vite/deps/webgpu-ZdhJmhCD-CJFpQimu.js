import { $ as traceSourceInfo, B as onFlushTrace, D as emitTrace, H as prod, L as isTracing, O as findPow2, P as isFloatDtype, R as mapSetUnion, W as range, Z as strip1, h as UnsupportedRoutineError, i as DEBUG, m as UnsupportedOpError, n as AluGroup, o as Executable, p as SlotError, s as FpHash, t as AluExp, tt as tuneWebgpu } from "./backend-Be4lJ1CU-AZOnUAoD.js";
//#region node_modules/@jax-js/jax/dist/webgpu-ZdhJmhCD.js
var threefrySrc = `
...
function nullaryKernelSource(device, kernel) {
	...
	let exp = kernel.exp.substitute({ gidx: AluExp.special("int32", "gidx", kernel.size) }).simplify();
	let uniforms = [];
...
function createSort(device, type) {
	...
	return bitonicSortShader(device, dtype, n, prod(shape.slice(0, -1)), false);
}
function createArgsort(device, type) {
	const dtype = type.inputDtypes[0];
	const shape = type.inputShapes[0];
	const n = shape[shape.length - 1];
	return bitonicSortShader(device, dtype, n, prod(shape.slice(0, -1)), true);
}
/**
...
var MAX_TIMESTAMP_QUERIES = 4096;
var activeBatch = /* @__PURE__ */ new WeakMap();
...
var MAX_REUSABLE_BUFFER_BYTES = 64 * 1024 * 1024;
var MAX_REUSABLE_BUFFERS_PER_SIZE = 64;
