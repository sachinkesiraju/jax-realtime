...
export class KyutaiStreamingTranscriber implements Transcriber {
  ...
  bestResult(): { text: string; confidence: null } {
    return { text: this.bestText(), confidence: null };
  }
  ...
  async finalizeResult(): Promise<{ text: string; confidence: null }> {
    ...
    return { text: this.committedText.trim(), confidence: null };
  }
